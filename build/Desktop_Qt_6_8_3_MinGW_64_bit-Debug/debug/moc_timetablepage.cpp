...
static constexpr auto qt_meta_stringdata_ZN13TimetablePageE = QtMocHelpers::stringData(
    "TimetablePage",
    "requestSwitchToList",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13TimetablePageE[] = {
...
Q_CONSTINIT const QMetaObject TimetablePage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13TimetablePageE.offsetsAndSizes,
    qt_meta_data_ZN13TimetablePageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13TimetablePageE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TimetablePage, std::true_type>,
        // method 'requestSwitchToList'
...
void TimetablePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (TimetablePage::*)();
            if (_q_method_type _q_method = &TimetablePage::requestSwitchToList; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *TimetablePage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13TimetablePageE.stringdata0))
