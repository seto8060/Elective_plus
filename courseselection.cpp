...
CourseSelection::CourseSelection(const QVector<CourseInfo>& allCourses, const UserInfo& user, QWidget *parent)
...
void CourseSelection::setupUI()
{
    ...
    // 创建课程搜索页面
    CourseSearchPage *m_searchPage=new CourseSearchPage(m_allCourses,this);
    // 创建已选课程界面
