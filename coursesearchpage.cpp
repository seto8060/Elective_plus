...
CourseSearchPage::CourseSearchPage(const QVector<CourseInfo>& allCourses, QWidget *parent)
...
void CourseSearchPage::setupUI() {
    ...
    connect(m_addToFavoritesButton, &QPushButton::clicked, this, &CourseSearchPage::onAddToFavoritesClicked);
    connect(m_enrollButton, &QPushButton::clicked, this, &CourseSearchPage::onEnrollCourseClicked);
}
...
void CourseSearchPage::onAddToFavoritesClicked() {
    // 实现添加到收藏夹逻辑
}

void CourseSearchPage::onEnrollCourseClicked() {
    // 实现选课逻辑
}
